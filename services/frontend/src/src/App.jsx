...
import RNNResults from './pages/RNNResult'
import RNNTrain from './pages/RNNTrain'
  ...
  return (
    <Routes>
      ...
      <Route path="/history" element={
       ...
       <Route path="/rnn-train" element={
        <ProtectedRoute>
          <AppLayout><RNNTrain /></AppLayout>
        </ProtectedRoute>
      } />
      <Route path="/rnn-results/:id" element={
        <ProtectedRoute>
          <AppLayout><RNNResults /></AppLayout>
        </ProtectedRoute>
      } />
